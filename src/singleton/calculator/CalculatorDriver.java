...
public class CalculatorDriver {
    ...
    public static void main(String[] args) {
        ...
        for (Client client : clientList) {
            ...
            double bmi = ThreadSafeCalcTool.BMICalculator(client.getHeight(), client.getWeight(), client.getMeasurementSystem());
        ...
        System.out.println("The average BMI calculated in this run is "); threadSafeCalcTool.bmiAverage();
    }
